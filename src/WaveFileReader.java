...
public class WaveFileReader {  
    ...
    public WaveFileReader(String filename,String folder) {  
          
        this.initReader(filename, folder);  
    }  
    ...
    private void initReader(String filename, String folder){  
  
        try {
        	String fullName = System.getProperty("user.dir") + "/"+ folder + "/" + filename + "/" + filename + ".wav";
